...
const BLOG = {
  ...
  NEXT_REVALIDATE_SECOND:
    process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 5,
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'CX',
  BIO: process.env.NEXT_PUBLIC_BIO || 'Attention Is All You Need',
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.cxai.top',
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'MineralS365, 博客',
